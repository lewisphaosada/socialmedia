...
Setup postgresql, open the twittermockup folder, and run the application. Spring boot/onion architecture. A seeder and postman collection test is provided to test some mock data.
